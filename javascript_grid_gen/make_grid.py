...
def make_grid(receptor: str, ligand: str, grid_center: list) -> None:
    ...
    rec_coords, rec_layers = mol_to_points(rec, None)
    ...
    for parent, frag in frags:
        ...
        parent_coords, parent_layers = mol_to_points(parent, None)
        ...
        # generate batch
        grid = get_raw_batch(
            rec_coords, rec_layers, parent_coords, parent_layers, conn, None, None, None
        )
